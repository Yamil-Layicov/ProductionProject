...
export default {
    ...
    // cacheDirectory: "C:\\Users\\yamil.layicov\\AppData\\Local\\Temp\\jest",
    ...
    // The maximum amount of workers used to run your tests. Can
    //  be specified as % or a number. E.g. maxWorkers: 10% will 
    // use 10% of your CPU amount + 1 as the maximum worker number.
    //  maxWorkers: 2 will use a maximum of 2 workers.
    // maxWorkers: "50%",

    // An array of directory names to be searched recursively u
